...
# Custom HTML to position logos
st.markdown("""
    <div style="display: flex; justify-content: space-between; margin-bottom: 20px; width: 100%">
        <img src="https://www.pngall.com/wp-content/uploads/11/Made-In-India-Lion-PNG-Cutout.png" style="height: 78px">
        <img src="https://www.sharda.ac.in/attachments/site_logo/logo111.png" style="height: 52px;">
    </div>
...
st.write("Upload your Plant's Leaf Image and get predictions if the plant is healthy or not")
...
if uploaded_file != None:
    ...
    st.image(image.resize((700, 400)), width=None)
